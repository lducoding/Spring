...
import study.querydsl.dto.MemebrDto;
import study.querydsl.dto.QMemebrDto;
...
//                .fetch();
    ...
    public void findDtoBysetter() {
        List<MemebrDto> result = jpaQueryFactory
                .select(Projections.bean(MemebrDto.class,
                        member.username,
                        member.age))
                .from(member)
                .fetch();

        for (MemebrDto memebrDto : result) {
            System.out.println(memebrDto);
        }
    }
    ...
    public void findDtoByField() {
        List<MemebrDto> result = jpaQueryFactory
                .select(Projections.fields(MemebrDto.class,
                        member.username,
                        member.age))
                .from(member)
                .fetch();
    ...
    public void findDtoByConstructor() {
        List<MemebrDto> result = jpaQueryFactory
                .select(Projections.constructor(MemebrDto.class,
                        member.username,
                        member.age))
                .from(member)
                .fetch();
    ...
    public void findDtoByQueryProjection() {
        List<MemebrDto> result = jpaQueryFactory
                .select(new QMemebrDto(member.username, member.age))
                .from(member)
                .fetch();

        for (MemebrDto memebrDto : result) {
            System.out.println("memebrDto = " + memebrDto);
        }
    }
...
//                .where(usernameEq(usernameCond), ageEq(ageCond))
    ...
    public void sqlFunction2() {
        List<String> count = jpaQueryFactory
                .select(member.username)
                .from(member)
